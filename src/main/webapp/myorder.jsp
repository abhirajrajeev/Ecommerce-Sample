...
try
{
	...
	ResultSet rs=st.executeQuery("select * from bucket inner join product where bucket.product_id=product.id and bucket.email='"+email+"' and bucket.orderdate is not NULL");
	while(rs.next())
	{
		sno=sno+1;
%>
