...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <div class="topnav sticky">
            ...
            <a href="changesecurityqstn.jsp">Change Security Question <i class="fa fa-repeat"></i></a>
            <a href="changemobilenum.jsp">Change Mobile Number <i class='fas fa-phone'></i></a>
          </div>
           <br>
           <!--table-->
